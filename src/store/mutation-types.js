...
export const RECEIVE_USER_INFO = 'receive_user_info'//接收用户信息数组
export const RESET_USER_INFO = 'reset_user_info'//重置用户信息数组

export const RECEIVE_GOODS = 'receive_goods'//接收商品数组
export const RECEIVE_RATINGS = 'receive_ratings'//接收商家评价数组
export const RECEIVE_INFO = 'receive_info'//接收商家数组
...
export const RECEIVE_CARTFOODS = 'receive_cartfoods'//接收商家数组
export const CLEAR_CART = 'clear_cart'//清空购物车
export const RECEIVE_SEARCH_SHOPS = 'receive_search_shops'//接收搜索的商家列表
